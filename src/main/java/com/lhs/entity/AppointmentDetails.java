...
private AppointmentPatientStatus treatmentStatus;
...
public AppointmentPatientStatus getTreatmentStatus() {
	return treatmentStatus;
}
public void setTreatmentStatus(AppointmentPatientStatus treatmentStatus) {
...
public String toString() {
	return "AppointmentDetails [id=" + id + ", patientFirstName=" + patientFirstName + ", patientLastName="
			...
			+ appointmentDate + ", appointmentTime=" + appointmentTime + ", problemDescription=" + problemDescription
			+ ", assignedMedicines=" + assignedMedicines + ", treatmentStatus=" + treatmentStatus + ", treatmentPrice="
			+ treatmentPrice + ", totalMedicinesPrices=" + totalMedicinesPrices + ", medicineFromHospital="
			+ medicineFromHospital + "]";
}
