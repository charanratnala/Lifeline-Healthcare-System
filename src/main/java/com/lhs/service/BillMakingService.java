...
public class BillMakingService {
	...
	public void makeBill(Prescription appointmentDetails, Doctor doc) {
		...
		if (doctorRepo.existsById(doc.getId())) {
			...
			Prescription ad = billMakingRepo.save(appointmentDetails);
	...
	public Optional<Prescription> getBill(Prescription docs, AppointmentTable appointmentTable) {
	...
	public void export(HttpServletResponse response) throws IOException {
		...
		Paragraph paragraph2 = new Paragraph("Medical Report " + ap + "  " + app, fontParagraph);
